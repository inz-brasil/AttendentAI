...
const envSchema = z.object({
  ...
  SEARXNG_URL: z.string().url('SEARXNG_URL deve ser uma URL válida').default('http://localhost:8888'),
  ...
  VAULT_COMPACTION_DELAY_MS: z.coerce.number().int().positive().default(30000),
  VAULT_MAX_SUMMARY_TOKENS: z.coerce.number().int().positive().default(500),
  VAULT_COMPACTION_MODEL: z.string().min(1).default('gpt-4o-mini'),
  VAULT_CRON_SCHEDULE: z.string().min(1).default('0 3 * * *'),
...
function readRawEnv(): Record<keyof z.input<typeof envSchema>, string | undefined> {
  return {
    ...
    SEARXNG_URL: Bun.env.SEARXNG_URL,
    ...
    VAULT_COMPACTION_DELAY_MS: Bun.env.VAULT_COMPACTION_DELAY_MS,
    VAULT_MAX_SUMMARY_TOKENS: Bun.env.VAULT_MAX_SUMMARY_TOKENS,
    VAULT_COMPACTION_MODEL: Bun.env.VAULT_COMPACTION_MODEL,
    VAULT_CRON_SCHEDULE: Bun.env.VAULT_CRON_SCHEDULE,
